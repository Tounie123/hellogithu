...
获取每天的天气数据
python3
url:http://www.weather.com.cn/weatherld/101190401.shtml
'''
...
def get_html(url):
	...
	headers = {
	'User-Agent':
	'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecho) chrome/51.0.2704.103 Safari/537.36',
	'ContentType':
